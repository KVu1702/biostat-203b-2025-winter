...
```{bash}
zcat < ~/mimic/hosp/diagnoses_icd.csv.gz | head -n 2
```

```{r}
#Setting the subject ID
#ID <- (10001217) #This is the 
ID <- (10063848)
...
#Reading in diagnoses.csv.gz and d_icd_diagnoses.csv.gz to get 
#top three diagnoses for the subtitle
