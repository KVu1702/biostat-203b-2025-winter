...
#Note, our y is value and not value_num, we want the values to be a double
#and not a string
ggplot(joined_icu_chart, mapping = 
  aes(x = charttime, y = valuenum, color = abbr, group = abbr))+
  geom_point() +
  geom_line() +
