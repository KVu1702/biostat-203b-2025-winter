...
DuckDB is an database system that is portable, analytical, in-process, and open source. Unlike other database solutions, DuckDB uses a rich SQL dialect to read and write file in many supported formats, perform lightning fast queries
