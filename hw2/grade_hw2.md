...
- Q1 (14/20)
    ...
    - Q1.1 You didn’t mention how different readers handle data types. For example, read.csv reads subject_id as an integer, while read_csv treats it as a double. Also, read_csv and fread import time as POSIXct, while read.csv reads it as a character. `-3.0`
...
- Q2 (78/80)
    ...
    - Q2.5 (13/15)
    	...
    	Show the memory size (2.5GB) for the Parquet file with command, as it may change due to data updates. `-2.0`	
