...
#Creating our los_long variable, as in homework 4
mimiciv_icu_cohort <- mimiciv_icu_cohort %>%
  mutate(los_long = (los >= 2))

#We saw in homework 4 that some variables either had some biologically 
#impossible measurements (e.g. negative or unbelievable large values)
