...
gzip -dk ~/mimic/hosp/labevents.csv.gz ~/mimic/hosp/labevents
...
![Section 4.1.5 of Reproducible Research with R and
RStudio](~/biostat-203b-hw/hw1/rep-res-3rd-edition-4_1_5.png)
