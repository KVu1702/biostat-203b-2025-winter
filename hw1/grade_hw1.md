...
- Q3 (19/20)
  ...
  - Q3.8. Show run time of the script, using `time` commend. `-1.0`
...
No violations. The 80-character limit is a convention for code readability in scripts and functions. For text, you can have longer lines for better readability.
